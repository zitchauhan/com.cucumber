 ...
 * 
 * @Override public void start(Stage primaryStage) { Button button = new
 * Button("Click Me"); button.setOnAction(e -> {
 ...
 * 
 * primaryStage.setTitle("JavaFX Example"); primaryStage.setScene(scene);
 * primaryStage.show(); }
 * 
